...
export function MettreAJour({ update, majWeb }: MettreAJourProps) {
  ...
  // Le titre « Mettre à jour l'application » et son badge « À jour / Nouvelle
  // version » vivent désormais sur la barre de la carte repliable qui
  // regroupe cette carte et « Dernières mises à jour » (SettingsPage.tsx) —
  // pas de <Card> ici, sinon on doublerait le cadre.
  return (
    <CardContent className="flex flex-col items-start gap-3">
      {/* L'explication ne s'affiche QUE quand elle sert à décider, c'est-à-dire
          ...
          pour ne rien apprendre. Demande de Raphaël, 5 sept. : « rehausser,
          mais en compactant ». */}

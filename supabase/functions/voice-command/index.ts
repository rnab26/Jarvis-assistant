...
const ACTION_SCHEMA = {
  ...
  properties: {
    ...
    setting_cle: {
      ...
      description: "set_setting uniquement : lequel des neuf réglages connus changer. Voir la description de set_setting pour les setting_valeur acceptées par chacun.",
    },
    setting_valeur: {
      type: "string",
